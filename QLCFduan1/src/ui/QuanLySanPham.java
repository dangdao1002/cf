...
//        setLocationRelativeTo(null);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (maSP.isEmpty()) {
            ...
            MsgBox.alert(this, "Mã sản phẩm không để trống");
            return;
        }
        String tenSP = txtTenSanPham.getText();
        if (tenSP.isEmpty()) {
            //JOptionPane.showMessageDialog(rootPane, "Tên sản phẩm không để trống");
            MsgBox.alert(this, "Tên sản phẩm không để trống");
            return;
        }
        try {
            ...
            MsgBox.alert(this, "Mã sản phẩm không được trùng");
            }
        } catch (NumberFormatException ex) {
            //JOptionPane.showMessageDialog(rootPane, "Yêu cầu nhập số và không để trống");
            MsgBox.alert(this,  "Yêu cầu nhập số và không để trống");
        } catch (Exception ex) {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        try {
            ...
            MsgBox.alert(this,  "Không xóa được vì thông tin sản phẩm đang tồn tại trong hóa đơn");
                        return;
                    }
                }
                btnSua.setEnabled(false);
